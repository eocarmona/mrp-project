...
class AddPermissionsTable extends Migration
{
    ...
    public function up()
    {
      ...
      DB::table('syss_permissions')->insert([
      	['id_permission' => '1','name' => 'Módulo Producción', 'is_deleted' => '0','type_permission_id' => '1'],
      	['id_permission' => '2','name' => 'Módulo Calidad', 'is_deleted' => '0','type_permission_id' => '1'],
      	['id_permission' => '3','name' => 'Módulo Almacenes', 'is_deleted' => '0','type_permission_id' => '1'],
      	['id_permission' => '4','name' => 'Módulo Embarques', 'is_deleted' => '0','type_permission_id' => '1'],
      ]);
    }
